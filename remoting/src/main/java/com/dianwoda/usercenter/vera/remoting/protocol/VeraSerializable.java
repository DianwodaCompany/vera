...
public class VeraSerializable {
    private static final Charset CHARSET_UTF8 = Charset.forName("UTF-8");

    public static byte[] veraProtocolEncode(RemotingCommand cmd) {
        // String remark
    ...
    public static RemotingCommand veraProtocolDecode(final byte[] headerArray) {
